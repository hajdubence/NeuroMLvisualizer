...
CC=g++
SOUREFILES="NeuroMLvisualizer.cpp camera.cpp model_renderer.cpp cell_renderer.cpp shader.cpp shader_cylinder.cpp shader_triangle.cpp parser.cpp network.cpp enviroment.cpp"
